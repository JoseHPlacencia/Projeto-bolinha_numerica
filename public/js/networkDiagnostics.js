...
export function createNetworkDiagnostics(socket, snapshots, networkConfig = {}) {
    ...
    function print() {
        ...
        const row = {
            ...
            trailPathPrimitiveIncrementalUpdates: trailDiagnostics && trailDiagnostics.pathPrimitiveIncrementalUpdates,
            ...
            trailPathPrimitiveRebuiltPointCount: trailDiagnostics && trailDiagnostics.pathPrimitiveRebuiltPointCount,
            trailPathPrimitiveReusedBlockCount: trailDiagnostics && trailDiagnostics.pathPrimitiveReusedBlockCount,
            ...
            trailSelfPathPrimitiveIncrementalUpdates: trailDiagnostics && trailDiagnostics.selfPathPrimitiveIncrementalUpdates,
            ...
            trailSelfPathPrimitiveRebuiltPointCount: trailDiagnostics && trailDiagnostics.selfPathPrimitiveRebuiltPointCount,
            trailSelfPathPrimitiveReusedBlockCount: trailDiagnostics && trailDiagnostics.selfPathPrimitiveReusedBlockCount,
    ...
    function table(limit = 20) {
        ...
        const rows = (snapshotDiagnostics.events || [])
            ...
            .map(event => ({
                ...
                trailPathPrimitiveIncrementalUpdates: event.server && event.server.gameLoop && event.server.gameLoop.trails && event.server.gameLoop.trails.pathPrimitiveIncrementalUpdates,
                ...
                trailPathPrimitiveRebuiltPointCount: event.server && event.server.gameLoop && event.server.gameLoop.trails && event.server.gameLoop.trails.pathPrimitiveRebuiltPointCount,
                trailPathPrimitiveReusedBlockCount: event.server && event.server.gameLoop && event.server.gameLoop.trails && event.server.gameLoop.trails.pathPrimitiveReusedBlockCount,
                ...
                trailSelfPathPrimitiveIncrementalUpdates: event.server && event.server.gameLoop && event.server.gameLoop.trails && event.server.gameLoop.trails.selfPathPrimitiveIncrementalUpdates,
                ...
                trailSelfPathPrimitiveRebuiltPointCount: event.server && event.server.gameLoop && event.server.gameLoop.trails && event.server.gameLoop.trails.selfPathPrimitiveRebuiltPointCount,
                trailSelfPathPrimitiveReusedBlockCount: event.server && event.server.gameLoop && event.server.gameLoop.trails && event.server.gameLoop.trails.selfPathPrimitiveReusedBlockCount,
