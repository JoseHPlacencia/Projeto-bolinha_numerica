...
export function createNetworkDiagnostics(socket, snapshots, networkConfig = {}) {
    ...
    function print() {
        ...
        const row = {
            ...
            captureApplySimplifyAttempts: captureApply.operationSimplifyAttemptCount,
            captureApplySimplifyHits: captureApply.operationSimplifyHitCount,
            captureApplySimplifySubjects: captureApply.operationSimplifySubjectCount,
            captureApplySimplifyCaptured: captureApply.operationSimplifyCapturedCount,
            captureApplySimplifyInputPoints: captureApply.operationSimplifyInputPointCount,
            captureApplySimplifyOutputPoints: captureApply.operationSimplifyOutputPointCount,
            captureApplySimplifyAreaDrift: round(captureApply.operationSimplifyMaxAreaDrift),
            captureApplySubtractValidations: captureApply.operationSubtractValidationCount,
            captureApplySubtractValidationRejected: captureApply.operationSubtractValidationRejectedCount,
            captureApplySubtractFallbacks: captureApply.operationSubtractFallbackCount,
            captureApplySubtractResidualOverlapArea: round(captureApply.operationSubtractMaxResidualOverlapArea),
            ...
            captureApplySlowestSubtractFallback: captureApplySlowestSubtract.usedFallback,
            captureApplySlowestSubtractSimplified: captureApplySlowestSubtract.usedSimplified,
    ...
    function table(limit = 20) {
        ...
        const rows = (snapshotDiagnostics.events || [])
            ...
            .map(event => ({
                ...
                captureApplySimplifyAttempts: getEventCaptureApply(event) && getEventCaptureApply(event).operationSimplifyAttemptCount,
                captureApplySimplifyHits: getEventCaptureApply(event) && getEventCaptureApply(event).operationSimplifyHitCount,
                captureApplySubtractValidations: getEventCaptureApply(event) && getEventCaptureApply(event).operationSubtractValidationCount,
                captureApplySubtractValidationRejected: getEventCaptureApply(event) && getEventCaptureApply(event).operationSubtractValidationRejectedCount,
                captureApplySubtractFallbacks: getEventCaptureApply(event) && getEventCaptureApply(event).operationSubtractFallbackCount,
                captureApplySubtractResidualOverlapArea: getEventCaptureApply(event) && round(getEventCaptureApply(event).operationSubtractMaxResidualOverlapArea),
                ...
                captureApplySlowestSubtractFallback: getEventCaptureApply(event) && getEventCaptureApply(event).slowestSubtract && getEventCaptureApply(event).slowestSubtract.usedFallback,
                captureApplySlowestSubtractSimplified: getEventCaptureApply(event) && getEventCaptureApply(event).slowestSubtract && getEventCaptureApply(event).slowestSubtract.usedSimplified,
