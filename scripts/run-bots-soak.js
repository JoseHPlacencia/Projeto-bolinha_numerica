...
const trailCounterNames = [
    ...
    "pathPrimitiveBlockCount",
    "pathPrimitiveCacheHits",
    "pathPrimitiveCacheMisses",
    "pathPrimitiveCount",
    "pathPrimitiveIncrementalUpdates",
    "pathPrimitiveInputPointCount",
    "pathPrimitiveRebuiltPointCount",
    "pathPrimitiveReusedBlockCount",
    "selfCollisions",
    "selfPathPrimitiveBlockCount",
    "selfPathPrimitiveCacheHits",
    "selfPathPrimitiveCacheMisses",
    "selfPathPrimitiveCount",
    "selfPathPrimitiveIncrementalUpdates",
    "selfPathPrimitiveInputPointCount",
    "selfPathPrimitiveRebuiltPointCount",
    "selfPathPrimitiveReusedBlockCount",
