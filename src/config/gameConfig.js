...
const territory = Object.freeze({
    ...
    baseBorderWidth: 4,
    circleSegments: 96,
    degenerateSpikeMaxArea: 4,
    degenerateSpikeMaxEffectiveWidth: 1.25,
    degenerateSpikeMaxMouthWidth: 15,
    degenerateSpikeMaxPointSpan: 8,
    degenerateSpikeMinDepth: 4,
...
const network = Object.freeze({
    ...
    cullNumbersByViewport: true,
    cullPlayerPositionsByViewport: true,
