...
const { isBotPlayer } = require("./botIdentity");
const {
    clampPointToMap,
    getAngleDelta,
    getBotAi,
...
/**
 * Bot target, threat, expansion and territory-return policy.
 *
 ...
 * context shared with route safety. See .ai/docs/ARCHITECTURE.md before moving
