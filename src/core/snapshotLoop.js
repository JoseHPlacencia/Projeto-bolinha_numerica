...
function cloneCaptureApplyDiagnostics(diagnostics) {
    ...
    return {
        ...
        operationSubtractFallbackCount: diagnostics.operationSubtractFallbackCount,
        operationSubtractMaxResidualOverlapArea: diagnostics.operationSubtractMaxResidualOverlapArea,
        operationSubtractValidationCount: diagnostics.operationSubtractValidationCount,
        operationSubtractValidationRejectedCount: diagnostics.operationSubtractValidationRejectedCount,
